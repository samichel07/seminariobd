...
<head>
    ...
    <title>Búsqueda Afinidades - Teatro Marry Place</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="#">Tabla Afinidad</a></li>
                                    <li class="active">Búsqueda De Afinidades</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Búsqueda de afinidades</strong>
                            </div>
                        ...
                        $con=Conectar();
                        $id=$_POST['id_afinidad'];
                        $SQL = 'SELECT id_afinidad, obra, papel, artista, interpretaciones	 FROM afinidad WHERE id_afinidad =:Id_afinidad';
                        $stmt = $con->prepare($SQL);
                        $result = $stmt->execute(array(':Id_afinidad'=>$id));
                        $rows = $stmt->fetchAll(\PDO::FETCH_OBJ);

                        if(count($rows)){
                            //echo "Existe el registro de la afinidad";
                            foreach($rows AS $row){
                            ?>
                            <br>
                            ...
                            echo "El dato de la afinidad no existe en la base de datos";
                        }
                        }
                        ?>
                        </div>
