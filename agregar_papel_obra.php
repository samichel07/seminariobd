...
<body>
    ...
    <div class="col-sm-8">
    <form role="form" action="insert_papel.php" method="POST">
   
    <input type="text" class="form-control mb-3" name="nombre_papel" placeholder="Nombre Papel" required>
	...
	<input type="text" class="form-control mb-3" name="duracion" placeholder="Año de publicacion" required>
    <input type="text" class="form-control mb-3" name="atrezo" placeholder="Numero de representaciones" required>
