...
<body>
    ...
    <div class="col-sm-8">
    <form role="form" action="insertar_artista.php" method="POST">
   
    <input type="text" class="form-control mb-3" name="nombre_artistico" placeholder="Nombre Artistico" required>
    ...
    <input type="text" class="form-control mb-3" name="cache" placeholder="Cache" required>
    <input type="text" class="form-control mb-3" name="descripcion" placeholder="Descripcion" required>
    <input type="text" class="form-control mb-3" name="papel" placeholder="Papel Afin" required>
    <input type="text" class="form-control mb-3" name="cantidad" placeholder="Cantidad Interpretaciones" required>
