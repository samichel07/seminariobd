...
<html lang="es">
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Tabla Artistas</li>
                                </ol>
                            </div>
                        </div>
                    </div>
		...
		<!-- Completar los input de acuerdo a los campos de la tabla -->
        <div class="content">
		...
		<section>
			<h3>Buscar por Titulo de la Obras</h3>
			<input type="text" name="id" id="id" placeholder=" Titulo de la Obras">
		</section>
		<section>
			<h3>Buscar por Autor de la Obra</h3>
			<input type="text" name="nombre" id="nombre" placeholder="Autor de la Obra">
		</section> 
