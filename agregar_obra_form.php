...
<body>
    ...
    <div class="col-sm-8">
    <form role="form" action="insert_obra.php" method="POST">
   
    <input type="text" class="form-control mb-3" name="titulo_obra" placeholder="Titulo Obra" required>
   
    <select name="autor[]" id="autor[]" style="width:820px">
                    <option value=""> Seleccione un autor:</option>
                    <?php      
                        include 'conexion_teatro.php'; 
                        $sql = $db->query("SELECT nombre_artistico FROM autor");
                        if (!$sql) {
	...
	<input type="text" class="form-control mb-3" name="anio_publicacion" placeholder="Año publicacion" required>
    <input type="text" class="form-control mb-3" name="representaciones" placeholder="Representaciones" required>
