...
<body>
    ...
    <div class="col-sm-8">
    <form role="form" action="insert_autor.php" method="POST">
    ...
    <input type="text" class="form-control mb-3" name="precio_libreto" placeholder="Precio Libreto" required>
    <input type="text" class="form-control mb-3" name="precio_representacion" placeholder="Precio representacion" required>
