...
<head>
    ...
    <title>Búsqueda Personajes - Teatro Marry Place</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="#">Tabla Papel</a></li>
                                    <li class="active">Búsqueda De Personajes</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Búsqueda de personajes</strong>
                            </div>
                            <form rol="form" method="POST">
                            <div class="form-group">
                            &nbsp;
                            <input &nbsp; type="text" class="form-control" id="nombre_papel" placeholder="Ingrese el nombre del personaje que desee consultar" name="nombre_papel">
                            </div>
                        ...
                        $con=Conectar();
                        $id=$_POST['nombre_papel'];
                        $SQL = 'SELECT nombre_papel, obra, duracion, atrezo FROM papel WHERE nombre_papel =:Nombre_papel';
                        $stmt = $con->prepare($SQL);
                        $result = $stmt->execute(array(':Nombre_papel'=>$id));
                        $rows = $stmt->fetchAll(\PDO::FETCH_OBJ);
                        if(count($rows)){
                            //echo "Existe el registro del personaje";
                            foreach($rows AS $row){
                            ?>
                            <br>
                            ...
                            echo "El dato del personaje no existe en la base de datos";
                        }
                        }
                        ?>
                        </div>
