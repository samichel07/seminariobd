...
<body>
    ...
    <div class="col-sm-8">
    <form role="form" action="insert_teatro.php" method="POST">
   
    <input type="text" class="form-control mb-3" name="nombre_teatro" placeholder="Nombre Teatro" required>
    <input type="text" class="form-control mb-3" name="calle" placeholder="Calle y Número" required>
	<input type="text" class="form-control mb-3" name="localidad" placeholder="Localidad" required>
    <input type="text" class="form-control mb-3" name="provincia" placeholder="Provincia" required>
    ...
    <input type="text" class="form-control mb-3" name="aforo" placeholder="Aforo" required>
