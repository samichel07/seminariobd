...
<head>
    ...
    <title>Búsqueda Teatros - Teatro Marry Place</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="#">Tabla Teatro</a></li>
                                    <li class="active">Búsqueda De Teatros</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Búsqueda de teatros</strong>
                            </div>
                            <form rol="form" method="POST">
                            <div class="form-group">
                            &nbsp;
                            <input &nbsp; type="text" class="form-control" id="nombre_teatro" placeholder="Ingrese el nombre del teatro que desee consultar" name="nombre_teatro">
                            </div>
                        ...
                        $con=Conectar();
                        $id=$_POST['nombre_teatro'];
                        $SQL = 'SELECT nombre_teatro, calle_numero, localidad, provincia, telefono, categoria, aforo FROM teatro WHERE nombre_teatro =:Nombre_teatro';
                        $stmt = $con->prepare($SQL);
                        $result = $stmt->execute(array(':Nombre_teatro'=>$id));
                        $rows = $stmt->fetchAll(\PDO::FETCH_OBJ);
                        if(count($rows)){
                            //echo "Existe el registro del teatro";
                            foreach($rows AS $row){
                            ?>
                            <br>
                            <div class="panel panel-default">
                                ...
                                <table class="table">
                                    ...
                                    <td><?php print("".$row->provincia."<br>")?></td>
                            ...
                            echo "El dato del teatro no existe en la base de datos";
                        }
                        }
                        ?>
                        </div>
