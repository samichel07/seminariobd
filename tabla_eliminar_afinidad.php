                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Tabla Afinidad</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">ELIMINAR AFINIDAD</strong>
                            </div>
                            <div class="table-stats order-table ov-h">
                                <table class="table ">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php  echo $row['id_afinidad']?></td>
                                                <td><?php  echo $row['obra']?></td>
                                                <td><?php  echo $row['papel']?></td>
                                                <td><?php  echo $row['artista']?></td>
                                                <td><?php  echo $row['interpretaciones']?></td>             
                                                <td><a href="eliminar_afinidad.php?id=<?php echo $row['id_afinidad'] ?>" class="btn btn-danger">Eliminar</a></th>
