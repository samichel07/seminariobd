...
<body>
    ...
    <div class="col-sm-8">
    <form role="form" action="insert_afinidad.php" method="POST">
   
    <input type="text" class="form-control mb-3" name="id" placeholder="Id Afinidad" required>
    ...
    <select name="obra[]" id="obra[]" style="width:820px">
        ...
        <select name="papel[]" id="papel[]" style="width:820px">
                    <option value=""> Seleccione un Papel</option>
                    <?php      
                        include 'conexion_teatro.php'; 
                        $sql = $db->query("SELECT nombre_papel FROM papel");
                        if (!$sql) {
                            echo "Ocurrió un error.\n";
                            exit;
                        }
        ...
        <select name="artista[]" id="artista[]" style="width:820px">
                    <option value=""> Seleccione un artista:</option>
                    <?php      
                        include 'conexion_teatro.php'; 
                        $sql = $db->query("SELECT nombre_artistico FROM artista");
                        if (!$sql) {
                            echo "Ocurrió un error.\n";
                            exit;
                        }
	...
	<input type="text" class="form-control mb-3" name="interpretaciones" placeholder="Interpretaciones" required>
