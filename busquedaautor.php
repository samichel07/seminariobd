...
<head>
    ...
    <title>Búsqueda Autores - Teatro Marry Place</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="#">Tabla Autor</a></li>
                                    <li class="active">Búsqueda De Autores</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Búsqueda de autores</strong>
                            </div>
                            <form rol="form" method="POST">
                            <div class="form-group">
                            &nbsp;
                            <input &nbsp; type="text" class="form-control" id="nombre_artistico" placeholder="Ingrese el nombre artístico del autor que desee consultar" name="nombre_artistico">
                            </div>
                        ...
                        $SQL = 'SELECT nombre_artistico, nombre, apellidos, edad, precio_libreto, precio_representacion  FROM autor WHERE nombre_artistico =:Nombre_artistico';
                        $stmt = $con->prepare($SQL);
                        $result = $stmt->execute(array(':Nombre_artistico'=>$id));
                        $rows = $stmt->fetchAll(\PDO::FETCH_OBJ);
                        if(count($rows)){
                            //echo "Existe el registro del autor";
                            foreach($rows AS $row){
                            ?>
                            <br>
                            ...
                            echo "El dato del autor no existe en la base de datos";
                        }
                        }
                        ?>
                        </div>
