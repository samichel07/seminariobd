                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Tabla Artista</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">ELIMINAR ARTISTA</strong>
                            </div>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php  echo $row['papel_afin']?></td>
                                                <td><?php  echo $row['cantidad_interpretaciones']?></td>            
                                                <td><a href="eliminar_artista.php?nombre_artistico=<?php echo $row['nombre_artistico'] ?>" class="btn btn-danger">Eliminar</a></th>	                
                                        <?php 
                                            } }
                                        ?>
                                    </tbody>
