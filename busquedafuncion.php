...
<head>
    ...
    <title>Búsqueda Funciones - Teatro Marry Place</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="#">Tabla Funcion</a></li>
                                    <li class="active">Búsqueda De Funciones</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Búsqueda de funciones</strong>
                            </div>
                            <form rol="form" method="POST">
                            <div class="form-group">
                            &nbsp;
                            <input &nbsp; type="text" class="form-control" id="id_funcion" placeholder="Ingrese el identificador que desee consultar" name="id_funcion">
                            </div>
                        ...
                        $con=Conectar();
                        $id=$_POST['id_funcion'];
                        $SQL = 'SELECT id_funcion, fecha, hora, teatro, obra, id_afinidad  FROM funcion WHERE id_funcion =:Id_funcion';
                        $stmt = $con->prepare($SQL);
                        $result = $stmt->execute(array(':Id_funcion'=>$id));
                        $rows = $stmt->fetchAll(\PDO::FETCH_OBJ);
                        if(count($rows)){
                            //echo "Existe el registro de la función";
                            foreach($rows AS $row){
                            ?>
                            <br>
                            ...
                            echo "El dato de la función no existe en la base de datos";
                        }
                        }
                        ?>
                        </div>
